...
client.emojiler = {
  sagok: "<a:brita_sag:847394535105495090>",
  yildiz: "<a:brita_yildiz:838470519116398602>",
  sagok2: "<a:brita_sag2:847457018595639326>",
  mavinokta: "<:lycian_neonmavi:847457683191365712>",
  tac: "<a:brita_kral:847457424507011102>"
};
...
Date.prototype.toTurkishFormatDate = function (format) {
  ...
  client.login(config.BotToken).then(x => console.log(`[Brita] - Bot olarak giriş yaptı!`)).catch(err => console.error(`[Brita] - Bot giriş yapamadı | Hata: ${err}`));